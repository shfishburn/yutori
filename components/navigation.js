      ...
      <nav class="nav-wrapper">
        <div class="container mx-auto flex items-center justify-between py-4">
          ...
          <ul id="navMenu" class="hidden md:flex space-x-6">
            ...
            <li><a href="/strength/strength.html" class="text-gray-800">Strength Training</a></li>
          </ul>
        </div>
        ...
        <ul id="navMenuMobile" class="md:hidden hidden px-4 pb-4">
          ...
          <li class="py-1"><a href="/strength/strength.html" class="block text-gray-800">Strength Training</a></li>
        </ul>
      </nav>
    `;
  }
